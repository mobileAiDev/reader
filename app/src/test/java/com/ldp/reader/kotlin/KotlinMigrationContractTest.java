...
public class KotlinMigrationContractTest {
    ...
    @Test
    public void loginFeatureIsMvvm() {
        assertFalse(new File("src/main/java/com/ldp/reader/presenter/LoginPresenter.kt").exists());
        assertFalse(new File("src/main/java/com/ldp/reader/presenter/contract/LoginContract.kt").exists());
        assertKotlinOnly("src/main/java/com/ldp/reader/ui/activity/LoginViewModel");
    }

    @Test
    public void bookDetailFeatureIsMvvm() {
        assertFalse(new File("src/main/java/com/ldp/reader/presenter/BookDetailPresenter.kt").exists());
        assertFalse(new File("src/main/java/com/ldp/reader/presenter/contract/BookDetailContract.kt").exists());
        assertKotlinOnly("src/main/java/com/ldp/reader/ui/activity/BookDetailViewModel");
    }
