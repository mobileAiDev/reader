...
public class HomeUiResourceContractTest {
    ...
    public void mainMenuKeepsCustomOverlayActionContract() throws IOException {
        ...
        assertNotEquals(0, R.id.home_menu_import_source);
        ...
        assertEquals(4, countOccurrences(menuLayout, "android:layout_height=\"44dp\""));
        assertEquals(4, countOccurrences(menuLayout, "android:layout_width=\"20dp\""));
        assertEquals(4, countOccurrences(menuLayout, "android:layout_height=\"20dp\""));
        assertEquals(4, countOccurrences(menuLayout, "android:layout_marginLeft=\"8dp\""));
        assertEquals(4, countOccurrences(menuLayout, "android:paddingLeft=\"16dp\""));
        assertEquals(4, countOccurrences(menuLayout, "android:paddingRight=\"16dp\""));
        ...
        assertEquals(4, countOccurrences(menuLayout, "android:ellipsize=\"end\""));
        assertEquals(4, countOccurrences(menuLayout, "android:maxLines=\"1\""));
        assertEquals(4, countOccurrences(menuLayout, "android:textSize=\"16sp\""));
        assertTrue(menuLayout.contains("@drawable/ic_home_menu_import_24"));
        assertTrue(menuLayout.contains("@drawable/ic_home_source_engine_20"));
        ...
        assertTrue(countOccurrences(menuLayout, "android:tint=\"@color/home_menu_item\"") >= 4);
        assertTrue(countOccurrences(menuLayout, "android:textColor=\"@color/home_menu_item\"") >= 4);
    ...
    public void remoteFolderSaveReplacesStaleReadableChapterList() throws IOException {
        ...
        assertTrue(sourceProvider.contains("mapIndexedNotNull { index, canonicalChapter ->"));
